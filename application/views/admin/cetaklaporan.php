                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group date" id="inputTanggalAwal"
                                                            ...
                                                            <input placeholder="yyyy/mm/dd"
                                                                ...
                                                                data-date-end-date="0d" data-target="#inputTanggalAwal"
                                                                name="tgl_awal" />
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <div class="input-group date" id="inputTanggalAkhir"
                                                            ...
                                                            <input placeholder="yyyy/mm/dd"
                                                                ...
                                                                class="form-control datetimepicker-input"
                                                                data-date-end-date="0d" data-target="#inputTanggalAkhir"
                                                                name="tgl_akhir" />
                                                            <div class="input-group-append"
...
document.getElementsByName("tgl_akhir")[0].setAttribute('max', today);
