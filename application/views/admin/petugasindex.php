        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <div class="dropdown-menu" role="menu">
                                                        <a class="dropdown-item" href="#" data-toggle="modal"
                                                            data-target="#detailModal<?php echo $data->id_user; ?>">Detail
                                                            Petugas</a>
                    ...
                    $no = 1;
                    foreach ($petugas as $data) : ?>
                    <div class="modal fade" id="detailModal<?php echo $data->id_user; ?>" tabindex="-1" role="dialog"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                        ...
                                                        ?>
                                                    <span
                                                        class="<?php echo $roleClass; ?>"><?php echo $roleText; ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Status Akun</th>
                                                <td>
                                                    <?php
                                                        ...
                                                        ?>
                                                    <span
                                                        class="<?php echo $is_activeClass; ?>"><?php echo $is_activeText; ?></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Last Login</th>
                    ...
                    $no = 1;
                    foreach ($petugas as $data) : ?>
                    <div class="modal fade" id="ubahStatus<?php echo $data->id_user; ?>" tabindex="-1" role="dialog"
                    ...
                    <!-- RESET PASSWD -->
                    <div class="modal fade" id="resetPassword<?php echo $data->id_user; ?>" tabindex="-1" role="dialog"
                        aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
