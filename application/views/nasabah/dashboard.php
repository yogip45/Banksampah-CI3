                            ...
                            <div class="direct-chat-messages">
                                ...
                                <div class="direct-chat-msg">
                                    ...
                                    <img class="direct-chat-img"
                                        src="<?php echo base_url()?>adminlte/dist/img/user1-128x128.jpg"
                                ...
                                <div class="direct-chat-msg right">
                                    ...
                                    <!-- /.direct-chat-infos -->
                                    <img class="direct-chat-img"
                                        src="<?php echo base_url()?>adminlte/dist/img/user3-128x128.jpg"
                                        alt="message user image">
                                    <!-- /.direct-chat-img -->
                                    <div class="direct-chat-text">
                            ...
                            <div class="direct-chat-contacts">
                                <ul class="contacts-list">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="<?php echo base_url()?>adminlte/dist/img/user7-128x128.jpg"
                                                alt="User Avatar">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="<?php echo base_url()?>adminlte/dist/img/user5-128x128.jpg"
                                                alt="User Avatar">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="<?php echo base_url()?>adminlte/dist/img/user6-128x128.jpg"
                                                alt="User Avatar">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img class="contacts-list-img"
                                                src="<?php echo base_url()?>adminlte/dist/img/user8-128x128.jpg"
                                                alt="User Avatar">
