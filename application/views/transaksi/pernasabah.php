                          ...
                          <div class="card-body col-md-12">
                              <div class="row">
                                  <div class="card-body col-md-4">
                                      <form role="form" action="<?= base_url() ?>index.php/setoran/history"
                                          method="POST">
                                          <div class="form-group">
                                              <label for="inputDesa">Nomor Induk Nasabah</label>
                                              <div class="input-group">
                                                  <input type="text" class="form-control" id="inputNin" name="keyword"
                                                      readonly value="<?php $keyword ?>">
                                                  <div class="input-group-append">
                                                      <button class="btn btn-primary" data-toggle="modal"
                                                          data-target="#tampilNasabah" type="button">
