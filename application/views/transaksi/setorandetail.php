                            ...
                            <div class="text-left">
                              <div class="table-responsive">
                                <table class="table">
                                  <tr>
                                    <td style="width: 60%; vertical-align: top ">
                                      <h5><span id="id_setor"><?= $id_setor; ?></span>/<?= $nasabah['nama']; ?>/<span id="nin"><?= $nasabah['nin']; ?></span>
                                      </h5>
                                    </td>
                                  </tr>
                                  </tr>
                                ...
                                <table class="table">
                                  <tr>
                                    <td style="width: 60%; vertical-align: top ">
                                      <p>Saldo Awal: <span class="text-bold">Rp.
                                        </span> <span id="saldoLama" class="text-bold"><?= $nasabah['saldo_lama']; ?></span>
                                      </p>
                                      <p>Total Pendapatan: <span class="text-bold">Rp. </span> <span class="text-bold" id="total"></span>
                                      </p>
                        ...
                        <div class="form-group">
                          <select class="form-control" id="jenisSampah" name="jenis_sampah">
                            ...
                            <?php foreach ($jns_sampah as $sampah) : ?>
                              <option data-harga="<?= $sampah->harga ?>" value="<?= $sampah->id_sampah ?>"><?= $sampah->nama_sampah ?>
                              </option>
                            <?php endforeach ?>
                          </select>
                        </div>
          ...
          success: function(response) {
            if (response.status === 'success') {
              ...
              window.location.href =
                '<?php echo base_url('index.php/setoran/setoranindex'); ?>';
            } else {
