                                          ...
                                          <div class="col-md-3">
                                                  ...
                                                  <div class="card-body box-profile">
                                                      ...
                                                      <ul class="list-group list-group-unbordered mb-3">
                                                          <li class="list-group-item">
                                                              <b>Last Login</b> <a
                                                                  class="float-right"><?= date('d M H:i', strtotime($user['last_login'])) ?></a>
                                                          </li>
                                                      </ul>
                                                  </div>
                                              </div>
                                              ...
                                              <div class="card card-primary">
                                                  ...
                                                  <div class="card-body">
                                                      ...
                                                      <p class="text-muted">
                                                          <span
                                                              style="<?= $user['role'] == 3 ? 'color: red;' : ($user['role'] == 2 ? 'color: green;' : '') ?>">
                                                  ...
                                                  <div class="card-header p-2">
                                                      <ul class="nav nav-pills">
                                                          <li class="nav-item"><a class="nav-link active"
                                                                  href="#editProfile" data-toggle="tab">Edit Profile</a>
                                                          </li>
                                                          <li class="nav-item"><a class="nav-link" href="#gantiFoto"
                                                                  data-toggle="tab">Foto Profile</a></li>
                                                      </ul>
                                                  </div><!-- /.card-header -->
                                                  <div class="card-body">
                                                          ...
                                                          <div class="active tab-pane" id="editProfile">
                                                              <form class="form-horizontal"
                                                                  ...
                                                                  <div class="form-group row">
                                                                      ...
                                                                      <div class="col-sm-10">
                                                                          <input type="text" class="form-control"
                                                                              id="inputNama" placeholder="Nama Lengkap"
                                                                              name="nama"
                                                                  ...
                                                                  <div class="form-group row">
                                                                      ...
                                                                      <div class="col-sm-10">
                                                                          <input type="text" class="form-control"
                                                                              id="inputNama" placeholder="username anda"
                                                                              name="username"
                                                                              value="<?= $user['username'] ?>">
                                                              ...
                                                              <div class="card-body">
                                                                  <div class="tab-content">
                                                                      ...
                                                                      <div class="form-group">
                                                                          <label for="inputFoto">Pilih File, Max
                                                                              (2Mb)</label>
