                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                        data-target="#detailModal<?php echo $data->nin; ?>">
                                                        <i class="fas fa-info-circle"></i> Detail
                                                        Nasabah</a>
                                                    <a class="dropdown-item"
                                                        href="<?= base_url('index.php/setoran/historybynin/' . $data->nin) ?>">
                                                        <i class="fas fa-history"></i>
                                                        History Transaksi</a>
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item"
                                                        href="<?= site_url('index.php/petugas/edit_nasabah/' . $data->id_user) ?>">
                                                        Edit Nasabah</a>
                                                    <a class="dropdown-item" href="#" data-toggle="modal"
                                                    ...
                                                    <div class="dropdown-divider"></div>
                                                    <a class="dropdown-item text-danger" href="#" data-toggle="modal"
                                                        data-target="#hapusAkun<?php echo $data->id_user; ?>">
                            ...
                            $no = 1;
                            foreach ($nasabah as $data) : ?>
                            <div class="modal fade print-container" id="detailModal<?php echo $data->nin; ?>"
                                tabindex="-1" role="dialog" aria-labelledby="detailModal" aria-hidden="true">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            ?>
                                                        <span
                                                            class="<?php echo $statusClass; ?>"><?php echo $statusText; ?></span>
                                                    </td>
                                                </tr>
                            ...
                            $no = 1;
                            foreach ($nasabah as $data) : ?>
                            <div class="modal fade" id="ubahStatus<?php echo $data->id_user; ?>" tabindex="-1"
                            ...
                            <?php if ($data->showHapusAkun == true && $this->session->userdata('role') == 3) : ?>
                            <!-- HAPUS AKUN -->
                            <div class="modal fade" id="hapusAkun<?php echo $data->id_user; ?>" tabindex="-1"
                                role="dialog" aria-labelledby="hapusModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="resetPassword<?php echo $data->id_user; ?>" tabindex="-1"
                                role="dialog" aria-labelledby="hapusModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                            ...
                            <div class="modal fade" id="tampilPassword" tabindex="-1" role="dialog"
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <div class="input-group-append">
                                                            <button class="btn btn-primary" type="button" id="copyBtn">
                                                                <i class="fas fa-clipboard fa-fw"></i> <span
                                                                    id="is_salin"> salin</span>
                                                            </button>
                                                        </div>
                                                    </div>
                                                </div>
