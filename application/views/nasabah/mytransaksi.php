                    ...
                    <div class="card col-md-12">
                        <div class="card-header d-flex p-0">
                            ...
                            <ul class="nav nav-pills ml-auto p-2">
                                <li class="nav-item"><a class="nav-link active" href="#tab_1" data-toggle="tab">Setoran</a></li>
                                <li class="nav-item"><a class="nav-link" href="#tab_2" data-toggle="tab">Penarikan</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                                ...
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td class="text-center">
                                                        <?php if ($data->status == 0) : ?>
                                                            <button data-toggle="modal" data-target="#konfirmasiModal<?php echo $data->id_penarikan; ?>" type="submit" class="btn btn-success"><i class="fas fa-check"></i></button>
                                                        <?php else : ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                                ...
                                <?php
                                    $no = 1;
                                    foreach ($penarikan as $data) : ?>
                                        <div class="modal fade" id="konfirmasiModal<?php echo $data->id_penarikan; ?>" tabindex="-1" role="dialog" aria-labelledby="hapusModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="hapusModalLabel">Selesaikan Proses Penarikan?</h5>
