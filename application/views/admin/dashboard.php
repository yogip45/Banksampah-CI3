    ...
    <body>       
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Halo, <?= $user['nama_petugas'] ?></h1>
                            <div class="row">
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?= $jumlah['nasabah'] ?></div>
                            ...
                            <div class="panel panel-yellow">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?= $jumlah['petugas'] ?></div>
                                            <div>Petugas</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel panel-red">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <div class="huge"><?= $jumlah['transaksi'] ?></div>
                    ...
                    <div class="row">
                        ...
                        <div class="panel panel-default">
                                <div class="panel-heading">
                                    <i class="fa fa-bar-chart-o fa-fw"></i> Transaksi
