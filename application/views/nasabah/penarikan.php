                                      ...
                                      <div class="card card-primary card-outline">
                                          ...
                                          <div class="card-body col-md-8">
                                              <form role="form" method="POST"
                                                  action="<?php echo base_url() . 'index.php/nasabah/verify_penarikan'; ?>">
                                                  <div class="form-row">
                                                      <div class="form-group col-md-4">
                                                          <label for="inputDesa">Saldo Anda</label>
                                                          <div class="input-group">
                                                              <input value="Rp. <?= $nasabah['saldo']; ?>" type="text"
                                                                  class="form-control" id="tampilSaldo" readonly>
                                                      ...
                                                      <div class="form-group col-md-5">
                                                          ...
                                                          <input value="<?= $nasabah['nin']; ?>" type="text"
                                                              class="form-control" id="inputNin" name="nin" readonly>
                                                  ...
                                                  <div class="form-row">
                                                      <div class="form-group col-md-4">
                                                          ...
                                                          <input placeholder="Max <?= $nasabah['saldo']; ?>"
                                                              <?= set_value('jumlah_penarikan') ?> type="number"
                                                              class="form-control" id="inputJumlah"
